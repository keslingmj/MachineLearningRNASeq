...
### Model Predictors
I'm going to pull the definition and symbols for the 42 predictors in the model to see what genes they are.
```{r}
geneNames <- gsub("\\.ENSG.*","",coefsFullNames)[2:length(coefsFullNames)]
```
